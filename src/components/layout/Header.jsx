export default function Header() {
  return (
    <header className="w-full min-h-dashboardSection bg-negroProfundo text-blancoPuro flex items-center justify-between px-6 py-4 shadow-card">
      <h1 className="font-bruno text-aquaTurquesa text-3xl">TSolutions IPIDD</h1>

      <nav className="flex gap-6 font-montserratSlim text-sm">
