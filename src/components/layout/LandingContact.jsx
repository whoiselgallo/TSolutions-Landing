...
export default function LandingContact({ selectedPackage }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const leadData = {
      ...
      phone,
      package: pkg,
      message: message || "Solicitud inicial desde Landing Page",
      source: "Landing Contact Form",
      createdAt: new Date().toISOString()
    };

    try {
      // 1. Guardar datos en Base de Datos para Marketing
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-humo text-sm sm:text-base mt-2 max-w-2xl mx-auto">
            Ingresa tus datos básicos para iniciar tu <strong>Diagnóstico de Madurez Digital</strong> y acceder a nuestra agenda de sesiones estratégicas 1 a 1.
          </p>
        </div>
        ...
        >
          ...
          >
            <span>{status === "loading" ? "Guardando y Redirigiendo..." : "🚀 Enviar y Recibir Diagnóstico Inmediato"}</span>
